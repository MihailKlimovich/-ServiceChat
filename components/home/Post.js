...
const postFooterIcons = [
    {
        ...
        likedImageUrl: 'https://img.icons8.com/color/60/000000/filled-like.png'
    },
    {
        name: 'Like',
    ...
    {
        name: 'Like',
        imageUrl: 'https://img.icons8.com/external-creatype-outline-colourcreatype/60/ffffff/external-share-user-interface-creatype-outline-colourcreatype.png',
    },
    {
        name: 'Like',
